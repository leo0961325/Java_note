...
public class FindResponse {
     ...
     * @param player
     */
    public FindResponse(Player player){
        this.name = player.getName();
        this.teamName = player.getTeamName();
        this.position = player.getPosition();
        this.backnumber = player.getBacknumber();
        this.score = player.getScore();
        this.age = player.getDetail().getAge();
        this.country = player.getDetail().getCountry();
        this.salary =player.getDetail().getSalary();
        this.playerStatus = player.getStatus().getPlayerStatus();


    }

    public FindResponse(Player player , Detail detail , Status status){
        this.name = player.getName();
        this.teamName = player.getTeamName();
        this.position = player.getPosition();
        this.backnumber = player.getBacknumber();
