...
public class storeController {
    ...
    public StoreResponse postItem(@Valid @RequestBody StoreRequest storeRequest) throws Exception {
    ...
    public List<StoreResponse> findnameData(@RequestParam String name) throws DemoException {
    ...
    public String modifyData(@RequestBody StoreRequest storeRequest) throws DemoException {
